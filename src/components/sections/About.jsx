...
//                         <div className="rounded-xl p-6 hover:-y-1 transition-all">
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>
                  <strong> B.A - </strong>  DSB Campus Nainital       
                       (2016-2019)
                </li>
                <li>
                  Relevant Coursework : Mathematics , Economics, English Literature
                </li>
                <li>
                    Master of Arts - Economics      (2020-2022)
                </li>
              </ul>
            </div>
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <div className="space-y-4 text-gray-300">
                <div>
                  <h4 className="font-semibold">
                    {" "}
                    Worked at UnitedHealth Group  (2023-2025){" "}
                  </h4>
                  <p>
